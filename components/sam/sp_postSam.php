    ...
    */
    ...
    class sp_postSam extends sp_postComponent{
        ...
        function renderEditMode($value = ""){
            ...
            $html .= '<table id="samContainer-'. $this->ID .'" class="samContainer" cellpadding="0" style="width: 440px; max-width: 100%; margin-right: auto; margin-left: auto;">;
                ...
                $html .= '<tr id="samExtraControls">';
                    $html .= '<td>';
                        $html .= '<p id="samFramesIndicator-'. $this->ID .'" class="samFramesIndicator" style="text-align: center; padding-top: 10px;"> 0/300 </p>';
                        $html .= '<button id="samToggleOverlay-'. $this->ID .'" class="samToggleOverlay"/>';
                        $html .= '<button id="samRedoButton-'. $this->ID .'" class="samRedoButton" data-compid="' . $this->ID . '">Undo</button>';
